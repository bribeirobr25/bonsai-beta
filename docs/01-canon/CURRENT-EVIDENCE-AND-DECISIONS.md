...
- **iOS attention is extremely concentrated, and the median product has none.** A Track A teardown of the 27 registry products with a resolvable Apple identity (US, 3 Sep 2026 — `04-evidence/W2-PRICING-TEARDOWN.md`) finds **median ratings 0**, **19 of 27 with zero ratings**, and the **top three holding 93%** of 755 total. `OBSERVED`, one storefront, one date.
- **This is an active market, not a dying one.** **18 of 27 launched in 2026** and **22 of 27 were updated in 2026**. The zero-rating majority is current, maintained software that nobody has found — a different problem from abandonment.
- **26 of 27 are free at download.** The sole paid-upfront product, Bonsai Album at **$7.99**, is also second by ratings (193) — but it launched in 2011, so age alone may explain that. Free-by-default is a **convention, not a demonstrated requirement**.
