# Bonsai · W2 · Economic Structure Map v0.6

**Date:** 3 September 2026  
**Workstream:** W2 · Monetization & Economics  
**Status:** POST-RECONCILIATION CURRENT ANALYSIS · PRE-VALIDATION / PRE-MVP  
...
# 34. Block 6 · Cross-front feedback incorporated

W2 has now received formal feedback from W3 · Brand Identity & Marketing and W4 · Growth Strategy.

No material contradiction was identified by either front.

W2 therefore records the following as the **current cross-front aligned baseline for reconciliation**.

## 34.1 Shared value architecture

The three fronts now converge on the following **hypothetical value sequence**:
...
Every arrow remains a separate hypothesis.

This must **not** be interpreted as a validated funnel or product architecture.

Cross-front principle:

> **message that acquires ≠ value that retains ≠ value that monetizes.**

W2 will therefore continue to test economic value independently from Brand acquisition language and Growth activation mechanics.

---

## 34.2 One-Tree Dedicated Value becomes the primary joint gate

W3 and W4 both support the same central cross-front question:

> **Can a dedicated experience around one real tree create current differentiated value over Photos / Excel / notes before requiring collection-wide migration or long historical accumulation?**

Cross-front mapping:

- **W2:** G1 · Substitute Superiority + G2 · Time to Differentiated Current Value
- **W3:** Progress → Memory, bounded by Psychological Safety and Durable Trust
- **W4:** L2 · One-Tree Land-and-Expand

W4 F0 remains a cheap existence/falsification screen.

If L2 survives F0, the exact F1 design must be reconciled between W2 and W4 before execution, using W2 G1/G2 as economic confirmation gates.

Current W2 proposed targeted-cohort thresholds remain unchanged.

---

## 34.3 Comparable Journey gains a formal prerequisite

W3 continues to place Comparable Journey primarily in **Journey → Learning**.

W4 adds a material prerequisite that W2 accepts:

> **corpus density must be tested before participant utility/economic tests.**

Context fragmentation may occur across:

`species × climate × stage × intervention × state`.

Therefore A3 / E10 now has the following sequence:

1. **G10-A / L4-A · Corpus-Density Feasibility Shadow**
2. **G10-B / L4-B · Utility + Repeat Behavior**
3. Contribution / retention effect
4. WTP / value capture

This refines sequencing only.

Comparable Journey remains `UNVALIDATED` and remains a high-priority non-authority economic hypothesis.

---

## 34.4 Professional discovery is separated from professional Growth

W3 and W4 support W2's distinction:

> teacher/practitioner as distribution actor ≠ payer ≠ authority actor ≠ attestor.

W2 records the following sequencing rule:

### Can happen early
- G7A · recurring professional workflow discovery
- G7B · real budget / financial commitment discovery

### Must wait
- L5 · Teacher / Club Continuity as a Growth loop

L5 should not be treated as a Growth mechanism until user-level value is credible and professional workflow/budget evidence exists.

This preserves A2 as a high economic **research priority** without converting it into a roadmap priority.

---

## 34.5 Continuity remains a strategic hypothesis with a truth cost

W3 preserves Continuity as its principal long-term Brand Territory hypothesis.

W2 and W4 preserve export/data continuity primarily as a **trust / commitment gate**, not a demonstrated acquisition trigger.

Cross-front interpretation:

- Continuity may create long-term Brand meaning;
- user-controlled history may reduce commitment resistance;
- payment architecture remains open;
- the eventual economic/operational model must fund the truth of continuity.

W2 therefore preserves G12:

> **revenue duration must be compatible with service-obligation duration.**

No front authorizes literal promises equivalent to:

- forever;
- permanent;
- never lose your history;
- guaranteed decades of hosted continuity.

---

## 34.6 Subscription × Continuity remains deliberately unresolved

W3 explicitly supports keeping this tension open.

W2 interpretation remains:

### Recurring payment
Can fund recurring service obligation, but may feel like rent on user-created history.

### One-time / lifetime
May reduce recurring-payment rejection, but creates finite revenue against potentially long-lived service obligations.

### Hybrid
Structurally plausible but behaviorally/economically `UNVALIDATED`.

No payment architecture is selected by this alignment.

---

## 34.7 Migration, concierge and manual labor are real costs
...
must be measured as real costs.

Therefore:

> **concierge-assisted activation cannot be interpreted as scalable acquisition unless the labor burden is included in the economic model.**

This principle must later feed CAC/payback analysis.

---

## 34.8 Success ambition remains unresolved at founder level

W4 supports W2's use of:

- S1 · sustainable small business
- S2 · founder full-time business
- S3 · larger / venture-scale opportunity

as scenarios, not venture objectives.

The project still needs a founder-level decision on what success ultimately means before W2 can declare an absolute market ceiling “sufficient” or “insufficient”.

This does not block cheap falsification or the MVP Validation Strategy.

---

## 34.9 Cross-front support for amendments

### `W2-001`

Support now recorded:

- W2 → recommend `ACCEPT`
- W3 → support `ACCEPT`
- W4 → support `ACCEPT`

The amendment remains **PROPOSED until formal Cross-Front Reconciliation adopts it**.

### `W4-A`

Cross-front position:

- W4 accepts the refinement;
- W2 supports it;
- W3 supports it.

Interpretation:

> `export / data continuity concern` = primarily commitment/trust gate  
> `export / data continuity as acquisition trigger` = `UNVALIDATED`

---

# 35. Integrated validation sequence carried into reconciliation

W2 now supports carrying the following sequence into Cross-Front Reconciliation:

0. **L4-A / G10-A · Comparable Journey Corpus-Density Shadow**
1. **L2 + G1/G2 · One-Tree Dedicated Value**
2. **L1 · First-Tree Inception**
3. **G7A/B · Professional Workflow + Budget discovery**
4. **L3 · Progression Artifact**
5. **L4-B / G10-B · Comparable Journey Utility**
6. **L5 · Teacher / Club Continuity**, gated by previous evidence
7. **L6 / G9 · Transfer / Provenance**, secondary / long-cycle

This is a **validation sequence proposal**.
...
- a Growth-channel commitment.

---

# 36. Current W2 status after W3/W4 feedback

W2 has no material unanswered question to W3 or W4 before Cross-Front Reconciliation.

Current status:

> **READY FOR CROSS-FRONT RECONCILIATION**

No core W2 conclusion has been reversed.

The material refinements are:

1. Comparable Journey now requires corpus-density feasibility before participant economic testing.
2. Professional economic discovery may occur early, while L5 Growth validation remains gated.
3. Acquisition, current utility, retention, trust and monetization must remain analytically separate.
4. `W2-001` is now cross-front supported but not yet canonical.
5. `W4-A` is cross-front supported as the correct classification of export/data-continuity concern.

The core W2 constraint remains:
...
# 37. Post-Reconciliation Economic Update · 4 September 2026

Cross-Front Reconciliation has now occurred.

This changes W2's **decision context**, not the underlying evidence status of P1/P2/P3.

## 37.1 S1 is now authoritative

Founder decision:

> **S1 · Sustainable small business is authoritative.**

Economic sufficiency threshold:

> **€75k annual contribution**

Contribution means after direct service costs, store/payment commission and support.

S2 (€200k) and S3 (€3m) remain sensitivity/upside scenarios.

S3 is an aspiration with **no identified evidence-backed path**.

### G11 now becomes operational

W2's G11 `STRONG` rule requires the **conservative economically eligible payer case**
to support at least **2×** the payer requirement.

Under S1:

| Net annual contribution / payer | S1 payer requirement | G11 `STRONG` requirement |
|---:|---:|---:|
| €20 | 3,750 | 7,500 |
| €22 | 3,410 | 6,820 |
| €25 | 3,000 | 6,000 |
...
These are retained paying users, not installs, downloads or ratings.

### €3/month shape

The reconciliation uses ~€22 net annual contribution as a **working scenario**
for a €3/month gross shape.

5,000 retained payers at €22 ≈ **€110k annual contribution**.

Therefore:

- this shape would clear S1 if reached;
- it does not validate €3/month;
- it does not validate subscription;
- it does not establish that 5,000 payers are reachable.

The ceiling question is now primarily a **reachability and retention** question.

---

## 37.2 A2 professional payer keeps rank but changes meaning

A2 remains the second-highest W2 validation priority.

Under S1:

> **A2 is no longer required to rescue venture viability.**

If G7A/B/C fails:

- S1 consumer economics remain live;
- S3 loses the only currently identified route to materially higher contribution per payer.

Therefore professional workflow discovery is now:

> **an S3-route probe / upside-shape probe**

rather than an S1 viability hedge.

---

## 37.3 W2-001 is adopted

`W2-001` was **ACCEPTED at Cross-Front Reconciliation on 4 September 2026**.
...
The previous phrase “Best economics” is superseded.

Any W2 document still labelling W2-001 as `PROPOSED` is historical only.

---

## 37.4 W4-A is ratified

Current classification:

> **export / data continuity concern = commitment / trust gate**

Acquisition caused specifically by export/continuity remains `UNVALIDATED`.

This is no longer a pending cross-front issue.

---

# 38. Pricing / Packaging Teardown incorporated

New Track A evidence from `W2-PRICING-TEARDOWN.md`:

For the 23 measurement-eligible US Apple products:

- 22/23 free at download;
- 1 paid upfront: Bonsai Album, $7.99;
- median ratings = 0;
- 16/23 have zero ratings;
- total ratings = 376;
- top three hold 96%;
- 17/23 launched in 2026;
- 20/23 updated in 2026.

### Economic interpretation

`OBSERVED`:
- free entry is the dominant convention;
- attention is highly concentrated;
- the category is actively crowded.

`UNVALIDATED`:
- free entry is required;
- ratings indicate active users/payers;
- any pricing architecture has superior economics.

This adds **attention/acquisition difficulty** as a sharper economic risk.

The merged census is maintained separately in:

`W2-MONETIZATION-CENSUS-MERGED-v1.0.md`.

---

# 39. Comparable Journey Step 0 result incorporated

`L4-A / G10-A` has been executed.
...
The accessible progression corpus frequently contains domain-model fields:
...
This supports the plausibility that real progression records can carry structured comparison context.
...
- heavily ficus;
- heavily Florida;
- effectively one climate.

Tier 2 matching produced repeated cases.

Tier 1:

> `species × climate × stage/state × intervention`

could not be tested meaningfully because climate had no variation.

State/outcome/intent were each present in only 7/12 cases.

### Economic implication

A3 remains alive but is now conditional on:

> **multi-source, multi-climate corpus access + sufficient context completeness**

This adds new cost/risk categories:

- corpus acquisition/access;
- normalization;
- context completeness;
- source diversity.

Participant `L4-B / G10-B` remains blocked until density feasibility improves.

---

# 40. Current W2 economic priorities after reconciliation

## A1 · Dedicated current workflow value
Still #1.

S1 viability depends more on this than on P3.

## A2 · Professional workflow / payer
Still #2.

Meaning changed:
> S3-route probe, not S1 viability hedge.

## A3 · Comparable Journey
Still #3 strategically, but currently:

> **`MIXED · DENSITY RISK HIGH` at G10-A**

and blocked from participant utility testing until corpus feasibility improves.

---

# 41. Current W2 bottleneck

The immediate binding constraint for the main S1 thesis is now participant access.

Step 1 remains:

> **L2 + W2 G1/G2 · One-Tree Dedicated Value**

Question:

> Can one real tree create current differentiated value over Photos / Excel / notes before collection-wide migration or historical accumulation?

Track A can continue in parallel, especially:
- manual monetization/IAP verification;
- additional multi-climate corpus access for G10-A.

But Track A should not become an excuse to postpone the load-bearing participant test.

---

# 42. Current W2 verdict

### `OBSERVED`
- real longitudinal recordkeeping;
- real paid use;
- real payment resistance;
- real good-enough substitutes;
- active competitive crowding;
- free-at-download convention;
- severe observable attention concentration.

### `SUPPORTED SIGNAL`
- S1 can theoretically be supported by a low-contribution consumer model if several thousand retained payers are reachable;
- A2 is the only currently identified route that materially changes the S3 contribution shape;
- Comparable Journey structure appears extractable from real progression writing;
- Comparable Journey density may be constrained more by corpus diversity/access than matching mechanics.

### `UNVALIDATED`
- Step 1 dedicated-value behavior;
- retained paid user count;
- WTP/renewal;
- CAC/payback;
- G11 eligible market size;
- professional payer;
- partner payment;
- Comparable Journey utility;
- provenance economics.

> **Post-reconciliation W2 question:** can Bonsai reach and retain enough economically eligible users to clear S1 without relying on unvalidated future authority or inflated market assumptions?
