# Bonsai · W2 · Monetization Census v1.1

**Date:** 4 September 2026  
**Status:** CURRENT CANONICAL W2 TRACK A ECONOMIC EVIDENCE  
...
## 9. Canonical W2 interpretation

This census does not select pricing or packaging.

Current W2 rules:

1. **Free at download is an observed convention, not a requirement.**
2. **One-time purchase remains a real category precedent.**
3. **Subscription remains viable as a shape but is behaviorally unvalidated for Bonsai.**
4. **Higher ARPU in authority/content bundles cannot be attributed to tracking.**
5. **Professional tiering is a hypothesis, not demonstrated superior economics.**
6. **Partner distribution does not establish partner payment.**
7. **The first landing-page validation should not freeze final pricing.**

The next useful census increment is manual verification of:
- current IAP tiers;
- free limits;
- paid value units;
- export/custody;
...
It must not delay participant Step 1.
